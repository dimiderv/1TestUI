...
function SetPrice(props) {
    ...
    useEffect( () => {
        ...
        const fetchItems = async () => {
            ...
            if(props.org==="org1"){
            temp="farmerFrontPage/setPrice";
            //back="/farmerFrontPage"; //assigning values like this doesnt work
            }else if (props.org==="org2"){
                temp="retailerFrontPage/setPrice";
                // back="/retailerFrontPage";
            }else{
                temp="supermarketFrontPage/setPrice";
            // back="/supermarketFrontPage";
            }
        ...
        return(
            <div className="mx-auto container-fluid p-5">
                <div className="d-block p-5">
                    <h3>{items.asset_id} is for sale </h3>
                </div>      
                <section>
                  
                        <PrintSalesPrice ID={items.asset_id} price={items.price} tradeID={items.trade_id} />
