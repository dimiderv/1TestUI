            ...
            <div class="container-fluid p-5">
                ...
                <div class="card-deck">
                    ...
                    <div class="card ">
                        ...
                        <p class="text-center"><a href="/supermarketFrontPage/updateAsset" class="btn btn-small btn-primary" >Update</a></p>
                    </div>
                    <div class="card">
                        <img class="card-img-top" src="./images/projects-macbook-stats.jpg" alt=""/>
                        <div class="card-body">
                        ...
                        <p class="text-center"><a href="/supermarketFrontPage/deleteAsset" class="btn btn-small btn-primary" >Delete</a></p>
                    </div>
                    <div class="card">
                        <img class="card-img-top" src="./images/projects-macbook-stats.jpg" alt=""/>
                        <div class="card-body">
                        ...
                        <p class="text-center"><a href="/supermarketFrontPage/deleteBuyRequest" class="btn btn-small btn-primary" >Delete Buy Request</a></p>
                    </div>
                    <div class="card ">
                        <img class="card-img-top" src="./images/projects-macbook-stats.jpg" alt=""/>
                        <div class="card-body">
                        ...
                        <p class="text-center"><a href="/supermarketFrontPage/requestToBuy" class="btn btn-small btn-primary" >RequestToBuy</a></p>
                    </div>
                    <div class="card ">
                        <img class="card-img-top" src="./images/projects-macbook-stats.jpg" alt=""/>
                        <div class="card-body">
                        ...
                        <p class="text-center"><a href="/supermarketFrontPage/agreeToBuy" class="btn btn-small btn-primary" >Agree To Buy</a></p>
                    </div>
                    <div class="card bg-danger">
                        <img class="card-img-top" src="./images/projects-macbook-stats.jpg" alt=""/>
                        <div class="card-body">
                            <h6 class="card-title">Set Price for an asset(NOT YET IMPEMENTED)</h6>
                            <p class="card-text ">Sets the price for the asset on owners implicit collection</p>

                        </div>
                        <p class="text-center"><a href="/supermarketFrontPage/setPrice" class="btn btn-small btn-primary" >Set Price</a></p>
                    </div>

                    <div class="card bg-danger">
                        <img class="card-img-top" src="./images/projects-robodog.jpg" alt=""/>
                        <div class="card-body">
                            <h6 class="card-title">Transfer Asset(NOT YET IMPEMENTED)</h6>
                            <p class="card-text ">You can Transfer Asset</p>
 
                        </div>
                        <p class="text-center"><a href="/supermarketFrontPage/transferRequestedAsset" class="btn btn-small btn-primary" >Transfer asset</a></p>
                    </div>
            ...
            <div class="container-fluid p-5">
                ...
                <div class="card-deck">
                    ...
                    <div class="card bg-danger">
                        ...
                        <p class="text-center"><a href="/supermarketFrontPage/assetExists" class="btn btn-small btn-primary" >Search asset</a></p>
                    </div>
                    <div class="card">
                        ...
                        <p class="text-center"><a href="/supermarketFrontPage/readAsset" class="btn btn-small btn-primary">Read Asset</a></p>
                    </div>

                    <div class="card bg-danger">
                        <img class="card-img-top" src="./images/projects-robodog.jpg" alt=""/>
                        <div class="card-body">
                            <h6 class="card-title">Read buy request(NOT YET)</h6>
                            <p class="card-text ">You can Read buy request from SuperMarket</p>

                        </div>
                        <p class="text-center"><a href="/supermarketFrontPage/readBuyRequest" class="btn btn-small btn-primary" >Read Request</a></p>
                    </div>
                    <div class="card bg-danger">
                        <img class="card-img-top" src="./images/projects-robodog.jpg" alt=""/>
                        <div class="card-body">
                        ...
                        <p class="text-center"><a href="/supermarketFrontPage/getAssetHistory" class="btn btn-small btn-primary" >Get Asset History</a></p>
                    </div>
                    <div class="card">
                        <img class="card-img-top" src="./images/projects-robodog.jpg" alt=""/>
                        <div class="card-body">
                        ...
                        <p class="text-center"><a href="/supermarketFrontPage/getAllAssets" class="btn btn-small btn-primary" >More info</a></p>
                    </div>
